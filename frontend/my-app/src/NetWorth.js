          ...
          <div>
            <div className="result-grid">
              <div className="result-card">
                ...
                <div className="value">
                  <AnimatedValue value={result.total_assets} />
                </div>
              </div>
              <div className="result-card">
                <div className="label">Total Liabilities</div>
                <div className="value" style={{ color: "#ff4d6d" }}>
                  <AnimatedValue value={result.total_liabilities} />
                </div>
              </div>
              <div className="result-card" style={{ background: result.net_worth >= 0 ? "rgba(0,255,136,0.08)" : "rgba(255,77,109,0.08)", borderColor: result.net_worth >= 0 ? "rgba(0,255,136,0.3)" : "rgba(255,77,109,0.3)" }}>
                ...
                <div className="value" style={{ color: netWorthColor }}>
                  <AnimatedValue value={Math.abs(result.net_worth)} prefix={result.net_worth >= 0 ? "$" : "-$"} />
                </div>
              </div>
            </div>
